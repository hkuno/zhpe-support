...
TMP_V1=`grep -e '^2,2,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $4}' | sort -n| head -1`
TMP_V2=`grep -e '^2,2,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $5}' | sort -n| head -1`
TMP_V3=`grep -e '^2,2,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $6}' | sort -n| head -1`
TMP_V4=`grep -e '^2,2,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $7}' | sort -n| head -1`
TMP_V5=`grep -e '^2,2,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $8}' | sort -n| head -1`
TMP_V6=`grep -e '^2,2,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $9}' | sort -n| head -1`
...
TMP_V1=`grep -e '^2,3,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $4}' | sort -n| head -1`
TMP_V2=`grep -e '^2,3,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $5}' | sort -n| head -1`
TMP_V3=`grep -e '^2,3,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $6}' | sort -n| head -1`
TMP_V4=`grep -e '^2,3,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $7}' | sort -n| head -1`
TMP_V5=`grep -e '^2,3,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $8}' | sort -n| head -1`
TMP_V6=`grep -e '^2,3,' ${INPUT}.dat.matched | grep -v \- |\
           awk -F, '{printf"%f\n", $9}' | sort -n| head -1`
